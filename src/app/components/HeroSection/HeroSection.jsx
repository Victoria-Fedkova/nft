        ...
        <div className=" mt-[28px] md:mt-0 md:mb-[115px] lg:mb-[145px]">
          <Container isHero>
            <div className="lg:max-w-[1019px] mx-auto ">
              ...
              <h2 className="flex items-center justify-between  font-right-grotesk font-[900] leading-[44px] md:leading-[60px] lg:leading-[164px] text-[44px] md:text-[92px] lg:text-[164px] uppercase text-left mb-[8px] md:mb-[16px] lg:mb-[30px]">
